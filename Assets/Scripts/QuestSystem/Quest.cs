...
public class Quest
{
    ...
    public void InstantiateCurrentQuestStep(Transform parentTransform)
    {
        ...
        {
            QuestObjective questStep = Object.Instantiate<GameObject>(questStepPrefab, parentTransform) 
                .GetComponent<QuestObjective>();
            questStep.InitializeQuestObjective(info.id, currentQuestStepIndex, questStepStates[currentQuestStepIndex].state);
        }
    }
